...
_RXCONSO_FIELDS = ['RXCUI', 'LAT', 'TS', 'LUI', 'STT', 'SUI', 'ISPREF', 'RXAUI', 'SAUI', 'SCUI', 'SDUI', 'SAB', 'TTY', 'CODE', 'STR', 'SRL', 'SUPPRESS', 'CVF']

_RXNREL_PATH = 'rrf/RXNREL.rrf'
_RXNREL_FIELDS = ['RXCUI1', 'RXAUI1', 'STYPE1', 'REL', 'RXCUI2', 'RXAUI2', 'STYPE2', 'RELA', 'RUI', 'SRUI', 'SAB', 'SL', 'DIR', 'RG', 'SUPPRESS', 'CVF'] 
...
def upload(root):
  ...
  with open(path, 'r') as f:
    ...
    for row in reader:
      ...
      concept = row['RXCUI']
      atom = row['RXAUI']
      coding = Coding('http://www.nlm.nih.gov/research/umls/rxnorm', None, row['CODE'], row['STR'])
